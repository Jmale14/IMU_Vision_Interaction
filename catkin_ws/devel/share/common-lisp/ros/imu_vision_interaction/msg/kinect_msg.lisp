...
(cl:ensure-generic-function 'im_stat-val :lambda-list '(m))
(cl:defmethod im_stat-val ((m <kinect_msg>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader imu_vision_interaction-msg:im_stat-val is deprecated.  Use imu_vision_interaction-msg:im_stat instead.")
  (im_stat m))
(cl:defmethod roslisp-msg-protocol:serialize ((msg <kinect_msg>) ostream)
  ...
  (cl:let* ((signed (cl:slot-value msg 'im_stat)) (unsigned (cl:if (cl:< signed 0) (cl:+ signed 256) signed)))
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <kinect_msg>) istream)
  ...
  (cl:let ((vals (cl:slot-value msg 'tally)))
    ...
    (cl:let ((unsigned 0))
      ...
      (cl:setf (cl:slot-value msg 'im_stat) (cl:if (cl:< unsigned 128) unsigned (cl:- unsigned 256))))
  msg
)
...
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<kinect_msg>)))
  ...
  "662361b7d3d4f58e85a3c72705f8eef3")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'kinect_msg)))
  "Returns md5sum for a message object of type 'kinect_msg"
  "662361b7d3d4f58e85a3c72705f8eef3")
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<kinect_msg>)))
  ...
  (cl:format cl:nil "float64[5] im_screw_probs_1~%float64[5] im_screw_probs_2~%float64[5] im_screw_probs_3~%float64[5] im_screw_probs_4~%float64[5] tally~%bool safe_move~%int8 im_stat~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'kinect_msg)))
  "Returns full string definition for message of type 'kinect_msg"
  (cl:format cl:nil "float64[5] im_screw_probs_1~%float64[5] im_screw_probs_2~%float64[5] im_screw_probs_3~%float64[5] im_screw_probs_4~%float64[5] tally~%bool safe_move~%int8 im_stat~%~%"))
